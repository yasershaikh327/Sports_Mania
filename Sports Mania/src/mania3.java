 ...
 * @author syase
 */
public class mania3 extends javax.swing.JFrame {
 ...
 String db_URL ="jdbc:mysql://localhost:3306/sports_mania?zeroDateTimeBehavior=convertToNull";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mania3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
