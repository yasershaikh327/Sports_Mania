...
String db_URL="jdbc:mysql://localhost:3306/sports_mania?zeroDateTimeBehavior=convertToNull";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TRACK EVENT: 4 X 100");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(76, 76, 76)
                        .addComponent(n_tf, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addGroup(layout.createSequentialGroup()
                .addGap(18, 18, 18)
                .addComponent(team_com, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(team_com, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(n_tf, javax.swing.GroupLayout.DEFAULT_SIZE, 28, Short.MAX_VALUE)
         ...
         if(team_com.getSelectedIndex()==1)
 {
        ...
        {  
            ...
            rs=stmt.executeQuery("SELECT * FROM sports_mania_table WHERE Team='FYBBA' AND event='4x100 MIX';");
 ...
 else if(team_com.getSelectedIndex()==2)
 {
        ...
        {  
            conn=DriverManager.getConnection(db_URL,db_USER,db_password);
            stmt=conn.createStatement();
            rs=stmt.executeQuery("SELECT * FROM sports_mania_table WHERE Team='SYBBA' AND event='4x100 MIX';");
        ...
        else if(team_com.getSelectedIndex()==3)
 {
        ...
        {  
            conn=DriverManager.getConnection(db_URL,db_USER,db_password);
            stmt=conn.createStatement();
            rs=stmt.executeQuery("SELECT * FROM sports_mania_table WHERE Team='TYBBA' AND event='4x100 MIX';");
        ...
        else   if(team_com.getSelectedIndex()==4)
 {
        ...
        {  
            conn=DriverManager.getConnection(db_URL,db_USER,db_password);
            stmt=conn.createStatement();
            rs=stmt.executeQuery("SELECT * FROM sports_mania_table WHERE Team='FYBAMC' AND event='4x100 MIX';");
    ...
    else   if(team_com.getSelectedIndex()==5)
 {
        ...
        {  
            conn=DriverManager.getConnection(db_URL,db_USER,db_password);
            stmt=conn.createStatement();
            rs=stmt.executeQuery("SELECT * FROM sports_mania_table WHERE Team='SYBAMC' AND event='4x100 MIX';");
     ...
     else   if(team_com.getSelectedIndex()==6)
 {
        ...
        {  
            conn=DriverManager.getConnection(db_URL,db_USER,db_password);
            stmt=conn.createStatement();
            rs=stmt.executeQuery("SELECT * FROM sports_mania_table WHERE Team='TYBBMM' AND event='4x100 MIX';");
       ...
       else   if(team_com.getSelectedIndex()==7)
 {
        ...
        {  
            conn=DriverManager.getConnection(db_URL,db_USER,db_password);
            stmt=conn.createStatement();
            rs=stmt.executeQuery("SELECT * FROM sports_mania_table WHERE Team='TYBSW' AND event='4x100 MIX';");
       ...
       else   if(team_com.getSelectedIndex()==8)
 {
        ...
        {  
            conn=DriverManager.getConnection(db_URL,db_USER,db_password);
            stmt=conn.createStatement();
            rs=stmt.executeQuery("SELECT * FROM sports_mania_table WHERE Team='FYBBA T&T' AND event='4x100 MIX';");
       ...
       else   if(team_com.getSelectedIndex()==9)
 {
        ...
        {  
            conn=DriverManager.getConnection(db_URL,db_USER,db_password);
            stmt=conn.createStatement();
            rs=stmt.executeQuery("SELECT * FROM sports_mania_table WHERE Team='SYBBA T&T' AND event='4x100 MIX';");
       ...
       else   if(team_com.getSelectedIndex()==10)
 {
        ...
        {  
            conn=DriverManager.getConnection(db_URL,db_USER,db_password);
            stmt=conn.createStatement();
            rs=stmt.executeQuery("SELECT * FROM sports_mania_table WHERE Team='TYBBA T&T' AND event='4x100 MIX';");
       ...
       else   if(team_com.getSelectedIndex()==11)
 {
        ...
        {  
            conn=DriverManager.getConnection(db_URL,db_USER,db_password);
            stmt=conn.createStatement();
            rs=stmt.executeQuery("SELECT * FROM sports_mania_table WHERE Team='FYBCA' AND event='4x100 MIX';");
        ...
        else   if(team_com.getSelectedIndex()==12)
 {
        ...
        {  
            conn=DriverManager.getConnection(db_URL,db_USER,db_password);
            stmt=conn.createStatement();
            rs=stmt.executeQuery("SELECT * FROM sports_mania_table WHERE Team='SYBCA' AND event='4x100 MIX';");
        ...
        else   if(team_com.getSelectedIndex()==13)
 {
        ...
        {  
            conn=DriverManager.getConnection(db_URL,db_USER,db_password);
            stmt=conn.createStatement();
            rs=stmt.executeQuery("SELECT * FROM sports_mania_table WHERE Team='TYBCA' AND event='4x100 MIX';");
