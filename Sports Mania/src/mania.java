 ...
 * @author banzy
 */
public class mania extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        DEPARTMENT.add(bamc_rb);
        bamc_rb.setText("BAMC");

        DEPARTMENT.add(bsw_rb);
        bsw_rb.setText("BSW");

        DEPARTMENT.add(bca_rb);
        bca_rb.setText("BCA");
        ...
        DEPARTMENT.add(bbatt_rb);
        bbatt_rb.setText("BBA T&T");

        DEPARTMENT.add(bbmm_rb);
        bbmm_rb.setText("BBMM");

        DEPARTMENT.add(bba_rb);
        bba_rb.setText("BBA");
...
if((name_tf.getText().trim().equals("")))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mania.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
